...
import 'package:m_gaz/ui/home/measurement_devices/technological-measuring/bloc/technological_measuring_bloc.dart';
import 'package:m_gaz/ui/home/working_with_consumers/bloc/consumer_relations_bloc.dart';
...
Future<void> _setupFactory() async {
  ...
  di.registerFactory(() => ConsumerRelationsBloc());
  di.registerFactory(() => TechMeasureBloc());
}
