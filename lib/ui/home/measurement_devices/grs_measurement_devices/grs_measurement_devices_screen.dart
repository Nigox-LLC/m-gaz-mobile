...
import 'package:m_gaz/ui/home/measurement_devices/grs_measurement_devices/subpage/detail.dart';
import 'package:m_gaz/ui/home/measurement_devices/grs_measurement_devices/widget/grs_measurement_devices_card.dart';
...
class GRSMeasurementDevicesScreen extends StatefulWidget {
  const GRSMeasurementDevicesScreen({super.key});

  @override
  State<GRSMeasurementDevicesScreen> createState() =>
      _GRSMeasurementDevicesScreenState();
}

class _GRSMeasurementDevicesScreenState
    extends State<GRSMeasurementDevicesScreen> {
  ...
  void _onScroll() {
    if (_scrollController.position.pixels >=
      ...
      context.read<GrsMeasurementDevicesBloc>().add(
        GrsMeasurementDevicesLoadMore(),
      );
    }
  }

  Future<void> _onRefresh() async {
    context.read<GrsMeasurementDevicesBloc>().add(GrsMeasurementDevicesLoad());
  ...
  Widget _buildBody(GrsMeasurementDevicesState state) {
    switch (state.status) {
      case GrsMeasurementDevicesStatus.initial:
  ...
  Widget _buildDocumentList(GrsMeasurementDevicesState state) {
    final bool isTablet = _isTablet(context);
      ...
      child: isTablet
          ? GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GrsMeasurementDevicesCard(
                  item: item,
                  index: index,
                  onTap: () {
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GrsMeasurementDevicesCard(
                  ...
                  index: index,
                  onTap: () {
                    push(GrsDetailScreen(grsId: item.id));
                  },
                );
              },
            ),
