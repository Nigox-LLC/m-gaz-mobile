...
class TechMeasureScreen extends StatefulWidget {
  const TechMeasureScreen({super.key});

  @override
  State<TechMeasureScreen> createState() => _TechMeasureScreenState();
}

class _TechMeasureScreenState extends State<TechMeasureScreen> {
