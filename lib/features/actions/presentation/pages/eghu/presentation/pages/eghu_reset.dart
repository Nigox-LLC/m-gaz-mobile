...
import 'package:m_gaz/features/actions/presentation/pages/eghu/presentation/pages/eghu_reinstallation_create_page.dart';
    ...
    return EghuActionListPage(
      ...
      onAdd: () => Navigator.of(context).push(
        MaterialPageRoute<bool>(
          builder: (_) =>
              EghuReinstallationCreatePage(preselection: preselection),
        ),
      ),
    );
  }
